    ...
    function getInitialPosts() {
        const newsPosts = [
            ...
            },
            {
                ...
                contents: { ko: "DAY6의 원필이 이번 달 솔로 앨범으로 돌아옵니다. 5월에는 팬들과 가까이 소통할 수 있는 단독 콘서트도 개최할 예정입니다.", en: "Wonpil of DAY6 is returning with a solo album this month and will hold a standalone concert in May.", ja: "DAY6のウォンピル가 이번 달, 솔로 앨범으로 돌아옵니다. 5월에는 단독 콘서트도 개최할 예정입니다.", zh: "DAY6 的元弼将于本月带着个人专辑回归, 并计划于 5 月举办个人演唱会。", es: "Wonpil de DAY6 regresa con un álbum solista este mes and tendrá un concierto en solitario en mayo." },
                comments: [
